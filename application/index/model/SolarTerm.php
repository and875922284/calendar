...
{
    /** Get a year's solar terms to an array represented by DateTime array.
     *
     * @param $year
     *  The year that contains all the 24 terms of the year you want
     * @param string
     *  $timezone_or_longitude Timezone defined according the PHP.net manual timezone location words,
     * otherwise the number of the timezone(haven't written yet! the work to do), and even the longitude for more accurate
     * time(haven't written either)
     * @return array : The array of DateTime Objects describe the terms time, sub array keys is according constants start with TERM_*
     */
    ...
    /**
     * Get a previous solar term's time and it's integer code by a given time.
     *
     * @param string $datetime  a given time to find the solar term
    ...
    private static function getSolorTermName($code){
        switch ($code){
            case self::TERMS_VERNAL_EQUINOX: return '春分';
            case self::TERMS_CLEAR_AND_BRIGHT: return '清明';
            case self::TERMS_GRAIN_RAIN: return '谷雨';
            case self::TERMS_SUMMER_BEGINS: return '立夏';
            case self::TERMS_GRAIN_BUDS: return '小满';
            case self::TERMS_GRAIN_IN_EAR: return '芒种';
            case self::TERMS_SUMMER_SOLSTICE: return '夏至';
            case self::TERMS_SLIGHT_HEAT: return '小暑';
            case self::TERMS_GREAT_HEAT: return '大暑';
            case self::TERMS_AUTUMN_BEGINS: return '立秋';
            case self::TERMS_STOPPING_THE_HEAT: return '处暑';
            case self::TERMS_WHITE_DEWS: return '白露';
            case self::TERMS_AUTUMN_EQUINOX: return '秋分';
            case self::TERMS_COLD_DEWS: return '寒露';
            case self::TERMS_HOAR_FROST_FALLS: return '霜降';
            case self::TERMS_WINTER_BEGINS: return '立冬';
            case self::TERMS_LIGHT_SNOW: return '小雪';
            case self::TERMS_HEAVY_SNOW: return '大雪';
            case self::TERMS_WINTER_SOLSTICE: return '冬至';
            case self::TERMS_SLIGHT_COLD: return '小寒';
            case self::TERMS_GREAT_COLD: return '大寒';
            case self::TERMS_SPRING_BEGINS: return '立春';
            case self::TERMS_THE_RAINS: return '雨水';
            case self::TERMS_INSECTS_AWAKEN: return '惊蛰';
        }
        return false;
    }
    ...
    // 一度代表的弧度
    private static $RADIAN_PER_ANGLE = self::PI / 180.0;
...
//得到指定年份的所有节气，包括其上一年的冬至，无参数为当前年
//$result=SolarTerm::getSolarTerms('3300');

//得到指定时间的上一个节气，无参数为当前时间
//$result=SolarTerm::getPrevSolarTerm('2017-1-30 23:30:30');
